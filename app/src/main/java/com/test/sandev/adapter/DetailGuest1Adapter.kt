...
class DetailGuest1Adapter(private val context: Context, private val list: List<RecordModule.GuestinfoBean.GuestInfoBean.TwolistBeanX>) : RecyclerView.Adapter<DetailGuest1Adapter.DetailViewHolder>() {
