...
class DetaiGiest3Adapter(private val context: Context, private val list: List<RecordModule.GuestinfoBean.GuestInfoBean.FourlistBeanX>) : RecyclerView.Adapter<DetaiGiest3Adapter.DetailViewHolder>() {
