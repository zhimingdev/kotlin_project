...
class Detai2Adapter(private val context: Context, private val list: List<RecordModule.HostinfoBean.HostInfoBean.ThreelistBean>) : RecyclerView.Adapter<Detai2Adapter.DetailViewHolder>() {
