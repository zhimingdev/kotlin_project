...
class Detail1Adapter(private val context: Context, private val list: List<RecordModule.HostinfoBean.HostInfoBean.TwolistBean>) : RecyclerView.Adapter<Detail1Adapter.DetailViewHolder>() {
