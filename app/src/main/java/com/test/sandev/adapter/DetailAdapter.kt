...
class DetailAdapter(private val context: Context,private val list: List<RecordModule.HostinfoBean.HostInfoBean.OnelistBean>) : RecyclerView.Adapter<DetailAdapter.DetailViewHolder>() {
