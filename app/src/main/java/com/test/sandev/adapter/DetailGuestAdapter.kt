...
class DetailGuestAdapter(private val context: Context, private val list: List<RecordModule.GuestinfoBean.GuestInfoBean.OnelistBeanX>) : RecyclerView.Adapter<DetailGuestAdapter.DetailViewHolder>() {
