...
class Detai3Adapter(private val context: Context, private val list: List<RecordModule.HostinfoBean.HostInfoBean.FourlistBean>) : RecyclerView.Adapter<Detai3Adapter.DetailViewHolder>() {
