...
import com.test.sandev.ui.fragment.TPFragment;
...
public class CardItemTouchCallBack extends ItemTouchHelper.Callback {
    ...
    private TPFragment.CardAdapter mAdapter;
    private List mDatas;

    public CardItemTouchCallBack(RecyclerView recyclerView, TPFragment.CardAdapter adapter, List datas) {
